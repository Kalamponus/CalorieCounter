...
{
    public class UpdateGeneralDataCommandHandler : IRequestHandler<UpdateGeneralDataCommand, ErrorOr<Updated>>
    {
        private readonly UserContext _userContext;

        public UpdateGeneralDataCommandHandler(UserContext userContext)
        {
            _userContext = userContext;
        }

        public async Task<ErrorOr<Updated>> Handle(UpdateGeneralDataCommand request, CancellationToken cancellationToken)
        {
