...
{
    public class ChangeNameCommandHandler : IRequestHandler<ChangeNameCommand, ErrorOr<Updated>>
    {
        private readonly UserContext _userContext;

        public ChangeNameCommandHandler(UserContext userContext)
        {
            _userContext = userContext;
        }

        public async Task<ErrorOr<Updated>> Handle(ChangeNameCommand request, CancellationToken cancellationToken)
        {
